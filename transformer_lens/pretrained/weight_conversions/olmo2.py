...
def convert_olmo2_weights(olmo2, cfg: HookedTransformerConfig):
    ...
    # Some models with the olmo2 architecture use Grouped Query Attention, and so for these we need to modify
    ...
    # olmo2 has no biases anywhere and deals with everything else roughly like
    ...
    for l in range(cfg.n_layers):
        ...
        state_dict[f"blocks.{l}.attn.qnorm.w"] = olmo2.model.layers[l].self_attn.q_norm.weight
        state_dict[f"blocks.{l}.attn.knorm.w"] = olmo2.model.layers[l].self_attn.k_norm.weight
        
        W_Q = olmo2.model.layers[l].self_attn.q_proj.weight
        W_K = olmo2.model.layers[l].self_attn.k_proj.weight
        W_V = olmo2.model.layers[l].self_attn.v_proj.weight
        ...
        W_O = olmo2.model.layers[l].self_attn.o_proj.weight
        
        state_dict[f"blocks.{l}.ln1_post.w"] = olmo2.model.layers[l].post_attention_layernorm.weight
        ...
        # parameters should stay as bitsandbytes.nn.modules.Params4bit
        if not cfg.load_in_4bit:
            state_dict[f"blocks.{l}.mlp.W_in"] = olmo2.model.layers[l].mlp.up_proj.weight.T
            state_dict[f"blocks.{l}.mlp.W_gate"] = olmo2.model.layers[l].mlp.gate_proj.weight.T
            state_dict[f"blocks.{l}.mlp.W_out"] = olmo2.model.layers[l].mlp.down_proj.weight.T
        else:
            state_dict[f"blocks.{l}.mlp.W_in"] = olmo2.model.layers[l].mlp.up_proj.weight
            state_dict[f"blocks.{l}.mlp.W_gate"] = olmo2.model.layers[l].mlp.gate_proj.weight
            state_dict[f"blocks.{l}.mlp.W_out"] = olmo2.model.layers[l].mlp.down_proj.weight
        ...
        state_dict[f"blocks.{l}.ln2_post.w"] = olmo2.model.layers[l].post_feedforward_layernorm.weight
